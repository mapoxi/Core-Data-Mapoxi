...
//  Core Data
//
//  Created by Piotr Mlynarski on 04.02.2015.
...
- (void)createSampleData {
    ...
    for (Osoba *osoba in wczyt) {
        NSLog(@"Znaleziono w bazie danych: %@....", osoba.nazwisko);
    }

    [Osoba removeAllObjects];
}
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "com.mapoxi.Core_Data" in the application's documents directory.
